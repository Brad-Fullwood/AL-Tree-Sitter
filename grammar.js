...
// -------------------------------------------------------------------------
// This file was automatically generated by `al-gen`.
// Keywords extracted from Microsoft.Dynamics.Nav.CodeAnalysis.dll
// via the al-extract tool (data/al-language-data.json).
//
...
module.exports = grammar({
  ...
  externals: $ => [
    // Keyword categories extracted from Microsoft.Dynamics.Nav.CodeAnalysis.dll
    // via al-extract (data/al-language-data.json). No keyword strings are hardcoded here.
        $.kw_action,
    $.kw_actionref,
    $.kw_analysisview,
    $.kw_analysisviews,
  ...
  enum_value_declaration: $ => prec.right(seq(
    field('keyword', choice($.kw_value, $.object_keyword)),
    '(',
    field('id', $.integer),
    $.semicolon,
    field('name', $.name),
  ...
  name_or_keyword: $ => choice(
    ...
    $.kw_function,
    $.keyword,
    // Legacy/rare keywords that appear as identifiers in property values, types, or expressions
    $.kw_automation,
    $.kw_dotnetassembly,
    $.kw_dotnettypedeclaration,
    $.kw_program,
  ...
  _atom: $ => choice(
    ...
    // Specific named externals that need to appear in node-types.json
    $.op_and,
    $.op_or,
    $.op_xor,
    $.op_mod,
