...
module.exports = grammar({
  ...
  // Uses object_body (not braced_block) so nested content is structurally parsed:
  // trigger_declaration, property_assignment, procedure_declaration, etc.
  ...
  // Uses object_body so properties (Caption, Locked, etc.) are structurally parsed.
