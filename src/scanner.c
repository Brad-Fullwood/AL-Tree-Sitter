...
#ifdef __wasm__
// WASI provides standard malloc/calloc/free - use them directly
// Note: tree_sitter/alloc.h is NOT available in Zed's WASI SDK
#include <stdlib.h>
#endif
...
#include <ctype.h>
#include <string.h>
#include <stdlib.h>  // For getenv and malloc/free/calloc
#endif
